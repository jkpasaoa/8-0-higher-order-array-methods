 ...
 */
function printAllSongTitles(song) {
  songs.forEach((song) =>
...
//   let output = `${songs.title}`
//   return console.log(output)
//  }

// function printSongTitlesOverThreeMinutes(songs) {songs.forEach((song) => song.runtimeInSeconds > 180 ? console.log(song.title))}
